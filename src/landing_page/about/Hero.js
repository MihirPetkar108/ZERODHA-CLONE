    ...
    return (
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                <h1 className="fs-1 text-center" style={{ color: "#424242" }}>
            ...
            <div
                className="row p-5 mt-5 border-top ms-5"
            ...
            >
                ...
                <div className="col-5 p-5">
                    ...
                    <p>
                        Over 1.6+ crore clients place billions of orders every
                        year through our powerful ecosystem of investment
                ...
                <div className="col-5 p-5">
                    ...
                    <p>
                        ...
                        , our fintech fund and incubator, has invested in
                        several fintech startups with the goal of growing the
                    ...
                    <p>
                        ...
                        the media is saying about us or learn more about our
